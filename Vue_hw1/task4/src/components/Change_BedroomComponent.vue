<template>
  <div class="blog-content">
    ...
    <img class="blog-content__img" src="../assets/img/bedroom.jpg" alt="kitchen img">
    ...
    <p class="blog-content__text">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere
      in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have
      suffered alteration in some form, by injecthumour, or randomised words which don't look even slightly believable.
    </p>
    <img class="blog-content__img" src="../assets/img/bedroom2.jpg" alt="kitchen img">
    <p class="blog-content__text">Embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the
    ...
    <ol class="blog-content__list">
      <li class="blog-content__list-item">Contrary to popular belief.There are many variations of passages of Lorem Ipsum
    ...
    <img class="blog-content__img" src="../assets/img/bedroom3.jpg" alt="kitchen img">
    <p class="blog-content__text">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere
      in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have
      suffered alteration in some form, by injecthumour, or randomised words which don't look even slightly believable.
    </p>
