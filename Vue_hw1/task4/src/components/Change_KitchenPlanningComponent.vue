<template>
  <div class="blog-content">
    ...
    <img class="blog-content__img" src="../assets/img/KitchenPlanning1.jpg" alt="kitchen img">
    ...
    <img class="blog-content__img" src="../assets/img/KitchenPlanning2.jpg" alt="kitchen img">
    <p class="blog-content__text">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere
      in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have
      suffered.</p>
  </div>
